(function () {
  if (typeof Asteroids === "undefined") {
    ...
    GameView.prototype.end = function(){
      ...
      this.ctx.fillText("No More Lives. It's Over Fool!", .30 * window.innerWidth, .40 * window.innerHeight);
      this.ctx.fillText("Your Score: " + this.game.score , .30 * window.innerWidth, .50 * window.innerHeight);
      return;
    }
